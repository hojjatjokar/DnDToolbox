...
export default class App extends React.Component {
    ...
    render() {
        ...
        return (
            <div className='app'>
                <Toolbox clearClickHandle={this.clearClickHandle} drawLine={this.state.drawLine}
                         clickHandle={this.lineClickHandle}/>
                <CanvasFrame tools={tools} strokes={strokes} dropHandler={this.canvasFramedropHandler}
                             strokeDrawMouseDownHandler={this.strokeDrawMouseDownHandler}
                             strokeDrawMouseUpHandler={this.strokeDrawMouseUpHandler}/>
            </div>
        );
    }
}
